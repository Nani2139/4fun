...
function Locality() {
  ...
  return (
    <div className="locality-container">
      <div className="locality-headings">
        <h3>Locality</h3>
        <button className="view-map-btn">View on Maps</button>
      </div>
      <div className="locality-bottom">
        ...
        <div className="locality-right">
          <div className="landmarks">
            ...
            <ul>
              ...
              <li>
                <FontAwesomeIcon icon={faSubway} /> Teacher’s Colony Metro
                Station - 4.1 km
              </li>
              <li>
                <FontAwesomeIcon icon={faPlane} /> Guntur International Airport
                - 5.2 km
              </li>
            </ul>
          </div>
